...
def opencvdnn_thread():
    ...
    global image_ok,image_find_ok # 카메라 프레임 준비여부, 객체 탐지 여부
    global box_size
    global carState

    model = cv2.dnn.readNetFromTensorflow(
            "/home/jj/pi/AI_CAR/OpencvDnn/models/frozen_inference_graph.pb",
            "/home/jj/pi/AI_CAR/OpencvDnn/models/ssd_mobilenet_v2_coco_2018_03_29.pbtxt"
        )
